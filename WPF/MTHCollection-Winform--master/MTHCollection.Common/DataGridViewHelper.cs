...
namespace MTHCollection.Common
{
    public static class DataGridViewHelper
    {
        ...
        /// <param name="dgv">dgv控件</param>
        /// <param name="e">dgv参数</param>
        public static void DgvRowPaint(this DataGridView dgv, PaintEventArgs e, Color borderColor)
        {
        ...
        /// 奇偶换色
        /// </summary>        
        public static void DgvStyle(this DataGridView dgv, Color defaultBackColor, Color alternatingBackColor, Color gridColor)
        {
            //奇数行的背景色
